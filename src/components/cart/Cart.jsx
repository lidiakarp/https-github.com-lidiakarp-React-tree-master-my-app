...
const Cart = (props) => {
  const onAddOverlay = async (obj) => {
    try {
      ...
      if (findOverlay) {
        axios.delete(
          `https://6380d7bf786e112fe1bbb11b.mockapi.io/cart/${findOverlay.id}`
        );
        ...
        const { data } = await axios.post(
          "https://6380d7bf786e112fe1bbb11b.mockapi.io/cart",
          obj
        );
  ...
  const onAddFav = async (obj) => {
    try {
      ...
      if (findFavorites) {
        axios.delete(
          `https://6380d7bf786e112fe1bbb11b.mockapi.io/favorites/${findFavorites.id}`
        );
        ...
        const { data } = await axios.post(
          "https://6380d7bf786e112fe1bbb11b.mockapi.io/favorites",
          obj
        );

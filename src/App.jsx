...
function App() {
    ...
    React.useEffect(() => {
        fetch('http://localhost:8070/api/product').then((resJson) => {
            return resJson.json()
        }).then((myJson) => {
            setTyrs(myJson)
        })
    ...
    React.useEffect(() => {
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://6380d7bf786e112fe1bbb11b.mockapi.io/tyrs')

        
            const cartData = await
        axios.get('https://6380d7bf786e112fe1bbb11b.mockapi.io/cart')
            

            const favoritesData = await
        axios.get('https://6380d7bf786e112fe1bbb11b.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://6380d7bf786e112fe1bbb11b.mockapi.io/cart/${id}`)
